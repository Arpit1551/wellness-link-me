...
export const Route = createFileRoute("/payment")({
  ...
  head: () => ({
    meta: [
      { title: "Secure Payment | BrightSmile" },
      {
        name: "description",
        content: "Complete payment for your BrightSmile virtual consultation.",
      },
    ],
  }),
  component: Payment,
  ...
  return (
    <PageShell>
      <section className="booking-wash grid min-h-[calc(100vh-5rem)] place-items-center px-5 py-12">
        <div className="w-full max-w-xl rounded-3xl border border-border bg-background p-7 shadow-2xl shadow-primary/10 md:p-10">
          <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-primary/10 text-primary">
            <CreditCard />
          </span>
          <h1 className="mt-5 text-center font-display text-3xl font-bold">Secure checkout</h1>
          <p className="mt-2 text-center text-muted-foreground">
            Virtual dental consultation · 15 minutes
          </p>
          <div className="my-8 rounded-2xl bg-muted/60 p-5">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-success/20 bg-success/5 p-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              charged. Razorpay checkout activates when credentials are connected.
            </p>
          </div>
          {error && (
