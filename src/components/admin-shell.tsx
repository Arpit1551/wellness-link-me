  ...
  return (
    <div className="min-h-screen bg-muted/35">
          ...
          {items.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.to}
                onClick={() => setOpen(false)}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition-colors ${active ? "bg-sidebar-primary text-sidebar-primary-foreground shadow-sm" : "text-sidebar-foreground/65 hover:bg-sidebar-accent hover:text-sidebar-foreground"}`}
              >
      ...
      <div className="lg:pl-64">
        <header className="flex min-h-20 items-center gap-4 border-b border-border bg-background px-5 lg:px-8">
